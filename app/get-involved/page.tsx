...
// this content inside Membership — see docs/DESIGN.md §6.
  ...
  return (
    <section className="container" style={{ padding: "56px 0 96px" }}>
      ...
      <div style={{ maxWidth: 720 }}>
        <p style={{ fontSize: "var(--text-body-size)", lineHeight: "var(--text-body-line)", color: "var(--ink-700)", marginBottom: "var(--space-4)" }}>
